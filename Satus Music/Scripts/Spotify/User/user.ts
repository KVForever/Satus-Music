class User{
    ...
    public async usersTopTracks(type: string, timeRange: string = "medium_term", limit: number = 20, offset: number = 0): Promise<any> {
        if (limit < 0 || limit > 50) {
    ...
    public async usersTopArtists(type: string, timeRange: string = "medium_term"): Promise<any> {
